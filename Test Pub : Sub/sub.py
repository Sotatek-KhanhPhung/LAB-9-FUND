...
#         retry_delay=0,
#         client_properties={"connection_name": "sub-latency-test"},
#     )
...
#                 reconnects += 1
#                 downtime = time.time() - last_disconnect
#                 print(f"[SUB] connected (reconnects={reconnects}, downtime={downtime:.2f}s)")
#                 last_disconnect = None

#             # basic_get: đơn giản, dễ reconnect
...
#             print(
#                 f"[SUB] got seq={seq} id={msg_id} "
#                 f"send_ts_ms={send_ts_ms} recv_ts_ms={recv_ts_ms} latency={latency_ms}ms"
#             )

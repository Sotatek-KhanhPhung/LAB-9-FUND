...
# QUEUE = "q.repl_test"
# SEND_INTERVAL_SEC = 1.0  # gửi mỗi 1 giây
...
#         connection_attempts=1,  # tự retry ở vòng while
#         retry_delay=0,
#         client_properties={"connection_name": "pub-1s-test"},
#     )
...
#             print(f"[PUB] sent seq={seq} id={msg_id} ts_ms={send_ts_ms}")
    ...
    while True:
        try:
            if conn is None or conn.is_closed or ch is None or ch.is_closed:
                ...
                # KHÔNG queue_declare ở đây để tránh mismatch arguments quorum/classic
